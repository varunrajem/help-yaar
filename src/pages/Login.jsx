      ...
      <div className="flex flex-col items-center justify-center">
        <div className="bg-white shadow rounded lg:w-1/3 md:w-1/2 w-full p-10 mt-16">
          ...
          <button
            ...
            className="focus:outline-none cursor-pointer focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-10"
          >
            <svg
              width="19"
              height="20"
          ...
          <div className="mt-8">
            ...
            <p className="mt-3 hover:underline text-sm font-medium text-gray-800 cursor-pointer">
              Forgot Password?
            </p>
          </div>
        </div>
